...
import time
import os
from test_case.test_002 import Demo
...
if __name__ == '__main__':
    ...
    testsuite.addTest(Demo('setUp'))		# 一个一个添加测试用例，且按照添加的顺序执行
    testsuite.addTest(Demo('test_style_tag'))
    testsuite.addTest(Demo('test_actor'))
